...
export default function HomePage() {
  ...
  const filtered = useMemo(() => {
    ...
    return countries.filter((country) => {
      ...
      const matchesAvailability =
        availability === 'all' ||
        (availability === 'full' &&
          country.coverage === 'Full') ||
        (availability === 'partial' &&
          country.coverage === 'Partial') ||
  ...
  return (
    <main className="site-shell">
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          <div className="eyebrow">
            <span className="live-dot" /> GLOBAL DEBT INTELLIGENCE
          </div>

          <h1>
            Track the world&apos;s debt.
            <br />
            <span>Understand what it means.</span>
          </h1>

          <p>
            Explore external debt data, compare countries,
            and get plain-language insights — all in one
            place.
          </p>
          ...
          <div className="hero-actions">
            <a
              ...
              href="#countries"
            >
              Explore countries <ArrowUpRight />
            </a>
      ...
      <section className="content-grid" id="countries">
        ...
        >
          <div className="ai-badge">
            <span className="spark">✦</span> DebtScope AI
          </div>
          ...
          <p>
            Turn complex economic datasets into short,
            readable explanations — starting with English
            and Hindi.
          </p>
          ...
          <div className="ai-card">
            ...
            <strong>
              India&apos;s external debt moved higher year
              over year.
            </strong>

            <p>
              This is preview copy for the interface.
              Verified World Bank data and source citations
              will replace it.
            </p>
            ...
            <button
              ...
              className="ai-link"
            >
              Explain in हिन्दी <ArrowUpRight />
            </button>
          </div>
        </article>
      </section>
      ...
      <section
        className="panel availability-panel"
        id="availability"
      >
        <div className="section-heading">
          <div>
            ...
            <p className="panel-subtitle">
              Filter countries by how usable and current
              their debt data is.
            </p>
          </div>

          <span className="coverage-count">
            {filtered.length} of {countries.length} shown
          </span>
        </div>
      ...
      <section
        className="panel rankings-panel"
        id="rankings"
      >
        <div className="section-heading">
          <div>
            ...
            <h2>
              Top countries by external debt
            </h2>
          </div>
      ...
      >
        <article className="panel map-panel">
          ...
          <div className="map-stage">
            ...
            <div className="map-legend">
              <span>
                <i className="low" /> Lower debt
              </span>

              <span>
                <i className="high" /> Higher debt
              </span>
            </div>
          </div>
        </article>
        ...
        >
          ...
          <p>
            See how two economies compare across the same
            debt indicators.
          </p>
      ...
      <footer className="footer">
        ...
        <div className="footer-note">
          Global debt intelligence, designed for clarity.
          Data integrations and source citations are
          coming next.
        </div>
